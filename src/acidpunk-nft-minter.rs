...
pub trait AcindPunkMinter {
    ...
    fn mint(
        ...
        require!(
            ...
            "All tokens have been minted already or the amount you want to mint is to much. Check limits (totally). You have to fit in limits with the whole amount."
        );
